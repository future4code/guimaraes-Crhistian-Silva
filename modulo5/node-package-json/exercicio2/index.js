...
const num2 = Number(process.argv[4])
   ...
   switch(operation){
       case "soma" :
          console.log(red,`O resto da operação ${operation} é:`, num1 + num2)
           break;
       case "subtrai":
           console.log(yellow,`O resto da operação ${operation} é:`, num1 - num2)
           break;
       case "dividir":
           console.log(purple,`O resto da operação  ${operation} é:`, num1 / num2)
           break;
       case "multiplicar":
           console.log(green,`O resto da operação ${operation} é:`, num1 * num2)
           break;
        case "resto":
